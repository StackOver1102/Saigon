            ...
            <Routes>
                <Route element={<PrivateRoutes/>}>
                    <Route>
                        ...
                        <Route path="/events" element={<ProductScreen/>}/>
                        <Route path="/addEvent" element={<AddProduct/>}/>
                        <Route path="/events/:id/edit" element={<EditProductScreen/>}/>
                        <Route path="/groups" element={<OrderScreen/>}/>
                        <Route path="/addGroup" element={<AddVoucherScreen/>}/>
                        <Route path="/group/:id/edit" element={<EditOrdersScreen/>}/>
                        <Route path="/menu" element={<CategoryScreen/>}/>

                        <Route path="/users" element={<UserScreen/>}/>
                        <Route path="/addMenu" element={<AddCategory/>}/>
